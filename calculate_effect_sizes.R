...
# NOT USED.  delete from the app folder when done.
#David Allbritton, 2022   ## should probably use metafor::escalc instead....
#  A function to calculate effect sizes from submitted data, 
#  based on the analysis script of:
#
