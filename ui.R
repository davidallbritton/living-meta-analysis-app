                    ...
                    fluidRow(
                      tabsetPanel(id = "mainTabset",
                        ...
                        tabPanel("Bayesian Multilevel", value = "bayesian_multilevel",
                                 ...
                                 p('The Bayesian analogue of the "None (multilevel model)" aggregation option:',
                                 ...
                                 p('Requires "Aggregate over: None (multilevel model)" in the "Study criteria"',
                                   'panel.  Like the other results tabs, this analysis uses the settings as of',
                                   'the last press of "(Re)Calculate Meta-Analysis"; prior changes take effect',
                                   'at the next recalculation.  For per-group posteriors with a moderator, see',
                                   'the "Bayesian Multilevel Regression" tab.'),
                        ...
                        tabPanel("Bayesian Multilevel Regression", value = "bayesian_multilevel_regression",
                                 ...
                                 p('Requires "Aggregate over: None (multilevel model)", a moderator selected',
                                   'under "Moderator Selection", and a press of "(Re)Calculate Meta-Analysis";',
                                   'moderator and prior changes take effect at the next recalculation.'),
