...
###################   Shiny App v.0.7.1 2022.12.24  UI ####################################
                    ...
                    fluidRow(
                      tabsetPanel(
                        tabPanel("Explanation", 
                                 ...
                                 h4("Purpose:"),
                                 p("The goals of this project are to make it easier to conduct a Bayesian meta-analysis and to encourage meta-analysts to present their work as living, evolving states of knowledge rather than as fixed snapshots of the literature at a single point in time and from a single point of view.  Meta-analysts can upload data in an Excel file and interactively set selection criteria and analysis parameters to produce a Bayesian meta-analytic estimate of an effect size along with standard statistics and graphs.  Other researchers can alter the parameters of the analysis or change which studies are included and observe the results."), 
                                 h4("Updating Results:"),
