                    ...
                    tabsetPanel(id = "dataSetupPanel", selected = "Study criteria",
                      tabPanel("Load Data File",
                               ...
                               p('Save every left-panel selection (study criteria, moderator choice,',
                                 'and prior specifications) to a file, or load a previously saved file',
                                 'to restore those selections.  Load the matching data file first, then',
                                 'the selections file, and press "(Re)Calculate Meta-Analysis" afterwards.'),
