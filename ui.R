...
",
                                           ...
                                           ("This is an updated version of the app which adds a tab for frequentist meta-regression."),
                                           br(),
                                           ("Updated: 08/04/2024"),
                                           h4("Updates:"),
                        ...
                        tabPanel("Descriptives", value = "descriptives", printButton,
                                 ...
                                 p('These summaries describe the effect sizes currently selected by the',
                                   ...
                                   '(no need to press Re-Calculate).  Counts are effect-size rows (ES) and',
